...
//            this.biasesMatrices[layerIndex] = new Tensor(this.outputMatrices[layerIndex].getShape().toHeapArray()[0], this.outputMatrices[layerIndex].getShape().toHeapArray()[1]);
...
//            this.velocityWeightsMatrices[layerIndex] = new Tensor(this.weightsMatrices[layerIndex].getShape().toHeapArray()[0], this.weightsMatrices[layerIndex].getShape().toHeapArray()[1]);
//            this.velocityBiasesMatrices[layerIndex] = new Tensor(this.biasesMatrices[layerIndex].getShape().toHeapArray()[0], this.biasesMatrices[layerIndex].getShape().toHeapArray()[1]);
//            this.momentumWeightsMatrices[layerIndex] = new Tensor(this.weightsMatrices[layerIndex].getShape().toHeapArray()[0], this.weightsMatrices[layerIndex].getShape().toHeapArray()[1]);
//            this.momentumBiasesMatrices[layerIndex] = new Tensor(this.biasesMatrices[layerIndex].getShape().toHeapArray()[0], this.biasesMatrices[layerIndex].getShape().toHeapArray()[1]);
//        }
//    }
//
...
//        Tensor inputTensor = new Tensor(DoubleArray.fromArray(inputs), inputs.length, 1); //new Tensor(new double[][] { inputs });
//        for (int layerIndex = 0; layerIndex < this.weightsMatrices.length; layerIndex++) {
//            if (layerIndex == 0) {
...
//        Tensor targetTensor = new Tensor(DoubleArray.fromArray(targets), 1, targets.length);
...
//            if (layerIndex == this.netWorkDenseLayers.length - 1 && lossFunctionable.equals(LossFunction.CATEGORICAL_CROSS_ENTROPY) && this.netWorkDenseLayers[layerIndex].getActivationFunction().equals(ActivationFunction.SOFTMAX)) {
...
//            }
//            Tensor previousOutputTensor = (layerIndex == 0) ? new Tensor(DoubleArray.fromArray(inputs), 1, inputs.length) : Tensor.transpose(outputMatrices[layerIndex - 1]);
...
//            this.velocityWeightsMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.velocityWeightsMatrices[layerIndex], this.momentumFactorBeta1), Tensor.scalarMultiply(deltaWeightsTensor[layerIndex], 1 - this.momentumFactorBeta1));
//            this.velocityBiasesMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.velocityBiasesMatrices[layerIndex], this.momentumFactorBeta1), Tensor.scalarMultiply(deltaBiasesTensor[layerIndex], 1 - this.momentumFactorBeta1));
...
//
//            this.velocityWeightsMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.velocityWeightsMatrices[layerIndex], this.momentumFactorBeta1), Tensor.scalarMultiply(squaredDeltaWeightsTensor, 1 - this.momentumFactorBeta1));
//
//            Tensor newWeightsVelocityTensor = this.velocityWeightsMatrices[layerIndex];
//            Tensor rootWithVelocityWeightsTensor = Tensor.tensorMapping(deltaWeightsTensor[layerIndex], ((flatIndex, value) -> this.learningRate * value / Math.sqrt(newWeightsVelocityTensor.getData().get(flatIndex) + this.epsilon)));
//
//            // Biases
//            Tensor squaredGradientsTensor = Tensor.tensorMapping(deltaBiasesTensor[layerIndex], (_, gradient) -> Math.pow(gradient, 2));
//            this.velocityBiasesMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.velocityBiasesMatrices[layerIndex], this.momentumFactorBeta1), Tensor.scalarMultiply(squaredGradientsTensor, 1 - this.momentumFactorBeta1));
//
//            Tensor newBiasesVelocityTensor = this.velocityBiasesMatrices[layerIndex];
//            Tensor rootWithVelocityBiasesTensor = Tensor.tensorMapping(deltaBiasesTensor[layerIndex], (flatIndex, value) -> this.learningRate * value / Math.sqrt(newBiasesVelocityTensor.getData().get(flatIndex) + this.epsilon));
//
...
//            Tensor rootWithVelocityWegihtsTensor = Tensor.tensorMapping(deltaWeightsTensor[layerIndex], (flatIndex, deltaWeight) -> this.learningRate * deltaWeight / Math.sqrt(currentWeightVelocity.getData().get(flatIndex) + this.epsilon));
...
//            Tensor rootWithVelocityBiasesTensor = Tensor.tensorMapping(deltaBiasesTensor[layerIndex], (flatIndex, gradient) -> this.learningRate * gradient / Math.sqrt(currentBiasesVelocity.getData().get(flatIndex) + this.epsilon));
//            this.biasesMatrices[layerIndex].subtract(rootWithVelocityBiasesTensor);
//        }
//    }
//
...
//            deltaWeightsTensor[layerIndex] = Tensor.scalarMultiply(deltaWeightsTensor[layerIndex], -this.learningRate);
//
//            this.momentumWeightsMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.momentumWeightsMatrices[layerIndex], this.momentumFactorBeta1), Tensor.scalarMultiply(deltaWeightsTensor[layerIndex], 1 - this.momentumFactorBeta1));
//            this.momentumBiasesMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.momentumBiasesMatrices[layerIndex], this.momentumFactorBeta1), Tensor.scalarMultiply(deltaBiasesTensor[layerIndex], 1 - this.momentumFactorBeta1));
//
...
//
//            this.velocityWeightsMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.velocityWeightsMatrices[layerIndex], this.momentumFactorBeta2), Tensor.scalarMultiply(squaredGradientsWeights, 1 - this.momentumFactorBeta2));
//            this.velocityBiasesMatrices[layerIndex] = Tensor.add(Tensor.scalarMultiply(this.velocityBiasesMatrices[layerIndex], this.momentumFactorBeta2), Tensor.scalarMultiply(squaredGradientsBiases, 1 - this.momentumFactorBeta2));
//
...
//
//            Tensor updateWeights = Tensor.tensorMapping(momentumWeightsHat, (flatIndex, m) -> this.learningRate * m / (Math.sqrt(velocityWeightsHat.getData().get(flatIndex)) + this.epsilon));
//            Tensor updateBiases = Tensor.tensorMapping(momentumBiasesHat, (flatIndex, m) -> this.learningRate * m / (Math.sqrt(velocityBiasesHat.getData().get(flatIndex)) + this.epsilon));
//
...
//    }
//
//    public static Tensor getAppliedActivationFunctionTensor(Tensor tensor, ActivationFunction activationFunction) {
...
//    }
//
//    public static Tensor getDeactivatedActivationFunctionTensor(Tensor activatedTensor, ActivationFunction activationFunction) {
//        if (activationFunction.name().equals(ActivationFunction.SOFTMAX.name())) {
...
//    }
//
//    private void randomize(Tensor tensor) {
//        double stdDev = Math.sqrt(2.0 / tensor.getShape().toHeapArray()[1]);
//        for (int a = 0; a < tensor.getShape().toHeapArray()[0]; a++) {
//            for (int b = 0; b < tensor.getShape().toHeapArray()[1]; b++) {
